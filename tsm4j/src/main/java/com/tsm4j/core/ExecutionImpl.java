...
@Getter
public class ExecutionImpl<I, O> implements Execution<I, O> {
    ...
    ExecutionImpl(StateMachinePath<I> initPath) {
        ...
        this.onNewPath(initPath);
    }

    void onNewPath(@NonNull StateMachinePath<?> path) {
        if (path.isLeaf()) {
